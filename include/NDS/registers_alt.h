//////////////////////////////////////////////////////////////////////
//
// registers_alt.h -- alternate register definitions for gba code 
//						compatibility.  This file will likely not be
//						kept up to date and is only provided due to many 
//						requests.
//
...
#define REG_CARD_CR1       (*(vuint32*)0x040001A0)
#define REG_CARD_CR1H      (*(vuint8*)0x040001A1)
#define REG_CARD_CR2       (*(vuint32*)0x040001A4)
#define REG_CARD_COMMAND   ((vuint8*)0x040001A8)

#define REG_CARD_DATA      (*(vuint32*)0x04100000)
#define REG_CARD_DATA_RD   (*(vuint32*)0x04100010)

#define REG_CARD_1B0       (*(vuint32*)0x040001B0)
#define REG_CARD_1B4       (*(vuint32*)0x040001B4)
#define REG_CARD_1B8       (*(vuint16*)0x040001B8)
#define REG_CARD_1BA       (*(vuint16*)0x040001BA)
#endif
